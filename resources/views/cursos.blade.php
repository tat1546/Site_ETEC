...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-YvpcrYf0tY3lHB60NNkmXc5s9fDVZLESaAA55NDzOxhy9GkcIdslK1eN7N6jIeHz" crossorigin="anonymous"></script>
    <div class="container text-center">
        ...
        <div class="row">
            <div class="col bg-white p-4 bg-imagem-cur">   
                <h6 class="titulo">DEPARTAMENTOS</h6>
                <p class="text-justify" style="color: white;  font-size: 35px; font-weight: bold;">Coordenação de Cursos</p>
                <h1 style=" color: white; font-weight: normal;  font-size: 20px; margin-left: 100px; text-align: left; ">As Coordenações de Curso são responsáveis pelo conjunto de ações destinadas ao planejamento do ensino, à supervisão de sua execução, ao controle das atividades docentes em relação às diretrizes didáticas pedagógicas e administrativas, bem como pela otimização dos recursos físicos e didáticos disponíveis para os cursos mantidos pelas Etecs.</h1>
    ...
    <div class="container text-center">
        <div class="row align-items-center">
            <div class="col">
                        ...
                        <p class="text-justify1" style="font-size: 35px; font-weight: bold; padding-top: 100px;"  >Coordenador Novotec</p>
                        <p class="text-justify1 gray-text">Giovanna Littiere (Novotec Administração)</p>
                        <p class="text-justify1 gray-text">Leandro (Novotec Logística)  </p>
                        <p class="text-justify1 gray-text">Marcelo Collado (Novotec Desenvolvimento de Sistemas)   </p>
                        <p class="text-justify1 gray-text">Cibelle Ferreria Francoso (Novotec RH)   </p>
                        <p class="text-justify1 gray-text">Jeferson Roberto de Lima (Novotec Desenvolvimento de Sistemas AMS)</p><br><br>

                        <p class="text-justify1" style="font-size: 35px; font-weight: bold;"  >Coordenador Curso Técnico</p>
                        <p class="text-justify1 gray-text">Monyse Tesser Panacci (Técnico em Adminstração / Técnico em Contabilidade)</p>
                        <p class="text-justify1 gray-text">Ediney Ciasi Barreto (Técnico em Desenvolvimento de Sistemas)</p>
                        <p class="text-justify1 gray-text">Silvano Lack de Brito (Técnico em Logística / Técnico em Serviços Jurídicos)</p>
                        
                        <p class="text-justify1" style="font-size: 35px; font-weight: bold;"  >Contato</p>
                        <p class="text-justify1 gray-text"><b>Telefones:</b> (11) 2045-4018</p><br><br>
                </div>
        </div>
    </div>
</div>
