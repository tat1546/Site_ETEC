...
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-YvpcrYf0tY3lHB60NNkmXc5s9fDVZLESaAA55NDzOxhy9GkcIdslK1eN7N6jIeHz" crossorigin="anonymous"></script>
    <div class="container text-center">
        ...
        <div class="row">
            <div class="col bg-white p-4 bg-imagem-hum">   
                <h6 class="titulo">RECURSOS HUMANOS</h6>
                <h1 class="subtitulo">Gestão de Pessoas em Foco: Desbravando os <br>Desafios do Setor de Recursos Humanos com <br> Língua Portuguesa, Matemática e História!</h1>
             ...
             <div class="container text-center">
                 <div class="row align-items-center">
                    ...
                    <div class="col">
                        ...
                        <p class="text-justify2 gray-text">No setor de Recursos Humanos ou na área administrativa de empresas públicas e privadas de qualquer segmento, empresas de treinamento e desenvolvimento e agências de emprego.</p>
